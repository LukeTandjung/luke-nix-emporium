...
### Skills without installing Delta

For an independently installed Delta app (on macOS or Linux), enable only:
...
It does not require `programs.zed-delta.enable` or install the Delta package.
