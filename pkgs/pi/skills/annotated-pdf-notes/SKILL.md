...
compatibility: Requires Poppler utilities, ImageMagick, and Pi's PaddleOCR-VL paddle_ocr tool. The target notes may require Typst or its native Markdown renderer for validation.
metadata:
  author: Luke T
---
